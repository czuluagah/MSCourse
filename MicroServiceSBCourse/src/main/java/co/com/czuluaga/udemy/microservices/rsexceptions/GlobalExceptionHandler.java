...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> resourceNotFoundException(ResourceNotFoudException ex, WebRequest request) {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorDetails errorDetails = new ErrorDetails(Instant.now(), "Validation Failed", ex.getBindingResult().toString());
